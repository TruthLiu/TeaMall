...
import com.teamall.dao.*;
import com.teamall.pojo.*;
import com.teamall.service.IOrderService;
import com.teamall.util.BigDecimalUtil;
import com.teamall.util.DateTimeUtil;
import com.teamall.util.FTPUtil;
import com.teamall.util.PropertiesUtil;
import com.teamall.vo.OrderItemVo;
import com.teamall.vo.OrderProductVo;
import com.teamall.vo.OrderVo;
import com.teamall.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService{
    ...
    public ServerResponse pay(Long orderNo,Integer userId,String path){
        ...
        String subject = new StringBuilder().append("teamall扫码支付，订单号：").append(outTradeNo).toString();
...
//        goodsDetailList.add(goods2);
    ...
    public ServerResponse aliCallback(Map<String,String> params){
        ...
        Order order=orderMapper.selectByOrderNo(orderNo);
        if (order==null){
            return ServerResponse.createByErrorMessage("非茶叶商城的订单，回调忽略");
        }
